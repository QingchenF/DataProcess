...
#label_files_all = pd.read_csv("/Users/fan/Documents/Data/ABC_CBCL_label/ABCD_Label.csv")
...
for i, j in enumerate(predict_model.best_estimator_.estimators_):
    #print('第{}个模型的系数{}'.format(i, j.x_weights_))
    print('第{}个模型的系数{}'.format(i, j.coef_.shape))
